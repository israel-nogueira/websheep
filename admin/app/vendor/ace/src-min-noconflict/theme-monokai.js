ace.define("ace/theme/monokai",["require","exports","module","ace/lib/dom"],function(e,t,n){t.isDark=!0,
	...
	t.cssText=''+
				...
				'.ace-monokai .ace_constant.ace_character, .ace-monokai .ace_constant.ace_language, .ace-monokai .ace_constant.ace_numeric, .ace-monokai .ace_constant.ace_other {color: #AE81FF }'+
				...
				'.ace-monokai .ace_support.ace_constant, .ace-monokai .ace_support.ace_function {color: #66efe3 }'+
				'.ace-monokai .ace_fold {background-color: #A6E22E; border-color: #F8F8F2 }'+
				'.ace-monokai .ace_storage.ace_type, .ace-monokai .ace_support.ace_class, .ace-monokai .ace_support.ace_type {font-style: italic; color: #66D9EF }'+
				'.ace-monokai .ace_entity.ace_name.ace_function, .ace-monokai .ace_entity.ace_other, .ace-monokai .ace_entity.ace_other.ace_attribute-name, .ace-monokai .ace_variable {color: #A6E22E }'+
				...
				'.ace-monokai .ws-colunm-tag .ace_comment.ace_xml{color: #003c3c; background-color: #6ef8ff; font-weight: bold; border-radius: 4px;}'+
				'';
