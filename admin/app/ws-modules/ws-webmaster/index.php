...
############################################################################################################################################
	...
	$session = new session();
	$__TEMPLATE__BASE__ = new Template(INCLUDE_PATH.'admin/app/templates/html/ws-modules/ws-webmaster/template_base.html', true);
	$__TEMPLATE__BASE__->ROOT_WEBSHEEP 	= ROOT_WEBSHEEP;
	$__TEMPLATE__BASE__->INCLUDE_PATH 	= INCLUDE_PATH;
	$__TEMPLATE__BASE__->cache 			= rand(1,99999999);
	$__TEMPLATE__BASE__->block("ESTRUTURA");
	$__TEMPLATE__BASE__->show();
