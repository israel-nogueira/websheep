        ...
        if(substr($this->f['attr']['n'],0,8)=="websheep"){
            ...
            if(version_compare( $version,  $NewVersion)== -1){
                $info = Array(
                    ...
                    "version"=> $NewVersion,
                    "response"=>"<span style='color:#61A000;'>Versão encontrada:".$NewVersion."<br><b>Baixando atualizações...</b></span>"
                );
                ...
                $info = Array(
                    ...
                    "actualVersion"=> $version,
                    "version"=> $NewVersion,
                    "response"=>"<span style='color:#61A000;'><b>Parabéns!</b><br>Você já possúi a ultima versão do painel!</span>"
                );
            }
            ...
            $info = Array(
                ...
                "size"=>$this->f['size'],
                "version"=>0,
                "response"=> "<span style='color:#E42C00;'><b>Link inválido</b></span>"
            );
        }
